...
namespace Microsoft.Cci.Pdb {
  //////////////////////////////////////////////////////////////////////////
  //
  internal class DumpMisc {
    internal static void Dump(BitSet bits) {
      uint word;
    ...
    internal static void Dump(PdbFunction f, int indent) {
    ...
    internal static void Dump(PdbScope s, int indent) {
      string pad = new String(' ', indent);
    ...
    internal static void Dump(PdbSlot s, int indent) {
      string pad = new String(' ', indent);
    ...
    internal static void Dump(PdbSource s, int indent) {
      string pad = new String(' ', indent);
      Console.WriteLine("            {0}[{1}] : {2}", pad, s.name, s.index);
    }

    internal static void Dump(PdbLines s, int indent) {
      string pad = new String(' ', indent);
    ...
    internal static void Dump(PdbLine s, int indent) {
      string pad = new String(' ', indent);
      if (s.lineBegin == 0xfeefee && s.colBegin == 0 && s.colEnd == 0) {
        Console.WriteLine("            {0}off={1:x8} #---------",
                          pad, s.offset, s.lineBegin, s.colBegin);
      } else {
    ...
    internal static void Dump(DbiSecCon s) {
    ...
    internal static void Dump(DbiModuleInfo s) {
    ...
    internal static void Dump(PdbFileHeader f) {
    ...
    internal static void Dump(DataStream d) {
    ...
    internal static void Dump(byte[] bytes, int offset, int limit) {
