...
namespace Microsoft.Cci.MutableCodeModel {
  ...
  /// <summary>
  /// Mutator of a method body. Different from CodeMutator in that definitions (of members/types/parameters) are not duplicated. 
  /// This way, a definition found in methodBodyMutator can be referenced by another. 
  /// </summary>
  public class MethodBodyMutator : CodeMutator {

    /// <summary>
    /// 
    /// </summary>
    /// <param name="host"></param>
    public MethodBodyMutator(IMetadataHost host)
      : base(host) {
    }
    ...
    /// <param name="host"></param>
    /// <param name="copyOnlyIfNotAlreadyMutable"></param>
    public MethodBodyMutator(IMetadataHost host, bool copyOnlyIfNotAlreadyMutable)
      : base(host, copyOnlyIfNotAlreadyMutable) {
    }
    ...
    /// The returned object is in turn used to convert blocks of statements into lists of IL operations.</param>
    /// <param name="sourceLocationProvider">An object that can map the ILocation objects found in a block of statements to IPrimarySourceLocation objects. May be null.</param>
    public MethodBodyMutator(IMetadataHost host, SourceMethodBodyProvider ilToSourceProvider, SourceToILConverterProvider sourceToILProvider, ISourceLocationProvider/*?*/ sourceLocationProvider)
    ...
    /// The returned object is in turn used to convert blocks of statements into lists of IL operations.</param>
    /// <param name="sourceLocationProvider">An object that can map the ILocation objects found in a block of statements to IPrimarySourceLocation objects. May be null.</param>
    public MethodBodyMutator(IMetadataHost host, bool copyOnlyIfNotAlreadyMutable, SourceMethodBodyProvider ilToSourceProvider, SourceToILConverterProvider sourceToILProvider, ISourceLocationProvider/*?*/ sourceLocationProvider)
    ...
    public override IAddressableExpression Visit(AddressableExpression addressableExpression) {
      ...
      if (loc != null)
        ...
        IParameterDefinition/*?*/ par = def as IParameterDefinition;
        if (par != null)
          addressableExpression.Definition = par;
        else {
          IFieldReference/*?*/ field = def as IFieldReference;
          if (field != null)
            addressableExpression.Definition = this.Visit(field);
    ...
    public override ITargetExpression Visit(TargetExpression targetExpression) {
      ...
      if (loc != null)
        ...
        IParameterDefinition/*?*/ par = targetExpression.Definition as IParameterDefinition;
        if (par != null)
          targetExpression.Definition = par;
        else {
          IFieldReference/*?*/ field = targetExpression.Definition as IFieldReference;
          if (field != null) {
            if (targetExpression.Instance != null)
    ...
    public override IExpression Visit(BoundExpression boundExpression) {
      ...
      if (loc != null)
        ...
        IParameterDefinition/*?*/ par = boundExpression.Definition as IParameterDefinition;
        if (par != null)
          boundExpression.Definition = par;
        else {
          IFieldReference/*?*/ field = boundExpression.Definition as IFieldReference;
          boundExpression.Definition = this.Visit(field);
        }
    ...
    /// <returns></returns>
    public override IModuleReference Visit(IModuleReference moduleReference) {
